...
export function LocationMap({
  ...
  return (
    ...
    >
      <motion.div
        className="relative w-full h-70 overflow-hidden rounded-2xl bg-background border border-border"
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          >
            <MapPin className="size-8 text-gold drop-shadow-lg" style={{ filter: "drop-shadow(0 0 10px oklch(0.74 0.1 85 / 0.5))" }} />
          </motion.div>
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          ...
          <div className="space-y-1">
            ...
            <motion.div
              className="h-px bg-linear-to-r from-gold/50 via-gold/30 to-transparent"
