...
export function WoltButton({ size = "normal", className }: WoltButtonProps) {
  ...
  return (
    <a
      ...
      className={cn(
        "group relative inline-flex items-center gap-2 rounded-lg border-2 border-wolt-blue bg-transparent font-medium text-wolt-blue transition-all duration-300 hover:bg-wolt-blue/10 hover:shadow-[0_0_24px_rgba(0,157,224,0.2)] hover:scale-[1.02] active:scale-[0.98]",
        isSmall ? "gap-1 px-2.5 py-1.5" : "gap-2.5 px-7 py-3.5 text-base",
        className
      )}
